...
const ATTENDANCE=new Set(['getAbsensiEntryOptions','saveAbsensiEntry','getAttendanceSettings','saveAttendancePeriod','deleteAttendancePeriod','saveAttendanceAgenda','deleteAttendanceAgenda']);

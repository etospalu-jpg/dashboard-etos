...
const SCOPE='openid email https://www.googleapis.com/auth/spreadsheets.readonly https://www.googleapis.com/auth/drive.readonly';
...
module.exports=async function handler(req,res){
  try{
    ...
    await store.saveConfig({clientId,clientSecret,refreshToken:current?.refreshToken||'',pendingState:state},{connectedAt:current?.refreshToken?new Date().toISOString():null,account:EXPECTED_EMAIL,lastAttemptAt:new Date().toISOString(),requestedScopes:['spreadsheets.readonly','drive.readonly']});
